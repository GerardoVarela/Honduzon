...
/* FILTRADO POR CHAT*/
select USUARIOS.NOMBRE,MENSAJE.MENSAJE FROM MENSAJE join chat on MENSAJE.ID_CHAT=chat.ID_CHAT join USUARIOS on Mensaje.ID_USUARIO_EMISOR=USUARIOS.ID_USUARIO  WHERE CHAt.ID_CHAT=5
